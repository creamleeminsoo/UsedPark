package me.leeminsoo.usedpark.util;
...
public class CookieUtil {
    ...
    private static final String COOKIE_NAME = "post_view";

    public static void setViewCookie(HttpServletRequest request, HttpServletResponse response, Long postId) {
        Set<Long> viewedArticleIds = getCurrentViewedArticles(request);

        viewedArticleIds.add(postId);
